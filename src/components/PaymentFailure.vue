    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Pagamento Não Aprovado</h2>
        </div>
        <div class="px-6 py-4">
          <div class="text-center">
            ...
            <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">Não foi possível processar seu pagamento</h3>
