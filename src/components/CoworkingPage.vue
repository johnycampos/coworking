  ...
  <div class="min-h-screen flex flex-col">
          ...
          <section v-if="currentPage === 'booking' || currentPage === 'payment' || currentPage === 'success'" class="py-12 bg-gray-50 w-full">
            <div class="w-full px-4 sm:px-6 lg:px-8">
              <div class="max-w-7xl mx-auto">
                ...
                <!-- Seleção de Data -->
                <div v-if="selectedType !== 'monthly'" class="bg-white rounded-lg shadow p-6 mb-6">
                  <h3 class="text-lg font-semibold text-gray-900 mb-4">Selecione as Datas</h3>
                  ...
                  <div v-if="selectedDate.length > 0" class="mt-4 text-sm text-gray-600">
                    Datas selecionadas: {{ selectedDate.join(', ') }}
                  </div>
                </div>

                <!-- Seleção de Horário (apenas para reserva por hora) -->
                <div v-if="selectedType === 'hourly'" class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <!-- Resumo do Valor -->
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                  <h3 class="text-lg font-semibold text-gray-900 mb-4">Resumo do Valor</h3>
                  <div class="space-y-2">
    ...
    <footer class="bg-gray-800 text-white w-full">
      <div class="w-full py-8 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-gray-400 text-sm mt-2"> Av. Gov. Roberto Silveira, 470 - Centro, Nova Iguaçu - RJ, 26210-210</p>
      </div>
    </footer>
  </div>
</template>
